...
class train():
    def __init__(self,root,model_name,model_path,data_name,data_path):
        ...
        def sel_data():
            ...
            folder_name = os.listdir(os.path.dirname(os.path.abspath(__file__))+"/../Image_to_Train")
        ...
        def out_of():
            ...
            info = open("../models/"+name+"/information.txt",'w')
            ...
            #names복사해오기
            shutil.copyfile(data_str+"/train/_darknet.labels" , "../models/"+name+"/obj.names")
            ...
            instrument = "../darknet detector train ../models/"+name+"/obj.data ../models/"+name+"/yolo-obj.cfg yolov4.conv.137"
